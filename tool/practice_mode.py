...
class Practice:
    ...
    def practice_mode(self):
        ...
        while True:
            ...
            continue_practice = input("\nDo you want to continue y or n?: ").strip().lower()
...
# check answer part with corrext_idx .index and print question part with enumerate() and weights_for_q were helped/generated by chatgpt